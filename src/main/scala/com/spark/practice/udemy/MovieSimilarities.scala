...
object MovieSimilarities {
  ...
  def loadMovieNames() : Map[Int, String] = {
    ...
    var movieNames:Map[Int, String] = Map()
     ...
     val lines = Source.fromFile(new File(getClass.getClassLoader.getResource("u.item").toURI)).getLines()
     for (line <- lines) {
  ...
  def main(args: Array[String]) {
    ...
    val data = sc.textFile(new File(getClass.getClassLoader.getResource("u.data").toURI).getPath)
